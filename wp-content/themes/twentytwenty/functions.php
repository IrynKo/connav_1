...
function add_site_settings_to_menu(){
    add_menu_page( 'Site Settings', 'Site Setttings', 'manage_options', 'post.php?post='.get_page_by_path("site-settings",NULL,"page")->ID.'&action=edit', '', 
	'', 20);
}
...
function my_acf_op_init() {
    ...
    if( function_exists('acf_add_options_page') ) {
        ...
        $child = acf_add_options_sub_page(array(
			...
			'menu_title' => 'Footer',
			'page_slug' => 'theme-general-settings'
        ));
    }
}
 /*if(function_exist('acf_add_options_page')) {
	 acf_add_options_sub_page([
		 'page_title' => 'Theme Footer Settings',
		 'menu_title' => 'Footer',
		 'page_slung' => 'ttheme-general-setings'
